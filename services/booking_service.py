...
class BookingService(BaseService):
    ...
    def get_booking_list_data(self, 
    ...
    def get_booking_detail(self, booking_id: int) -> Dict:
        ...
        try:
            ...
            return {"success": False, "message": f"Error fetching booking: {str(e)}", "data": None}
    
    def get_new_booking_form_data(self, 
                                  channel: Optional[str] = None,
                                  channel_id: Optional[int] = None, 
                                  offline: Optional[bool] = False) -> Dict:
        """
    ...
    def create_booking(self, booking_data: Dict) -> Dict:
        ...
        try:
            with self.get_session() as session:
                ...
                self.log_action("create", "booking", new_booking.id, {
                    "property_id": new_booking.property_id,
                    "total_payout_vnd": new_booking.total_payout_vnd
                })
                
                return self.format_success_response(new_booking, "Booking created successfully")
    ...
    def get_edit_booking_form_data(self, booking_id: int) -> Dict:
        ...
        try:
            with self.get_session() as session:
                ...
                if not booking:
                    return self.format_error_response("Booking not found", {"booking_id": booking_id})
    ...
    def update_booking(self, booking_id: int, booking_data: Dict) -> Dict:
        ...
        try:
            with self.get_session() as session:
                ...
                booking.num_nights = (booking_data["end_date"] - booking_data["start_date"]).days
                ...
                self.log_action("update", "booking", booking_id, {
                    "property_id": booking.property_id,
                    "total_payout_vnd": booking.total_payout_vnd
                })
                
                return self.format_success_response(booking, "Booking updated successfully")
    ...
    def delete_booking(self, booking_id: int) -> Dict:
        ...
        try:
            with self.get_session() as session:
                ...
                return self.format_success_response(None, "Booking deleted successfully")
    ...
    def get_booking_room_assignment(self, booking_id: int) -> Dict:
        ...
        try:
            ...
            return {"success": False, "message": f"Error fetching room assignment: {str(e)}", "data": None}
    ...
    def create_room_assignment(self, booking_id: int, assignment_data: Dict) -> Dict:
        ...
        try:
            ...
            if existing:
                ...
                existing.revenue_attribution = assignment_data.get("revenue_attribution", "actual_room")
                ...
                return {"success": True, "data": existing, "message": "Room assignment updated successfully"}
            else:
                ...
                new_assignment = RoomAssignment(
                    ...
                    revenue_attribution=assignment_data.get("revenue_attribution", "actual_room"),
                ...
                return {"success": True, "data": new_assignment, "message": "Room assignment created successfully"}
            
        except Exception as e:
            return {"success": False, "message": f"Error creating room assignment: {str(e)}", "data": None}
        ...
        try:
            with self.get_session() as session:
                ...
                return self.format_success_response({
                    ...
                    "has_room_changes": len(assignments) > 0 and any(
                        a.booked_room != a.actual_room for a in assignments if a.booked_room and a.actual_room
                    )
                })
                
        except Exception as e:
            return self.format_error_response(f"Error fetching assignment history: {str(e)}")
    ...
    def calculate_room_revenue_attribution(self, booking_id: int) -> Dict:
        ...
        try:
            ...
            if not assignment or not assignment.actual_room or not assignment.booked_room:
            ...
            return {"success": False, "message": f"Error calculating revenue attribution: {str(e)}", "data": None}
    # ============ /ROOM ASSIGNMENT METHODS ============