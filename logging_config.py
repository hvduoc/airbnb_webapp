...
def log_security_event(action: str, user_id: int = None, ip_address: str = None, 
                      resource: str = None, success: bool = True, details: Dict[str, Any] = None):
...
def log_api_access(request_path: str, method: str, user_id: int = None, 
                  ip_address: str = None, status_code: int = None, duration: float = None):
