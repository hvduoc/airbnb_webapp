...
class ExpenseCreateRequest(BaseModel):
    ...
    vendor: Optional[str] = Field(None, max_length=255, description="Nhà cung cấp/vendor")
    note: Optional[str] = Field(None, max_length=500, description="Ghi chú thêm")
    date: str = Field(..., description="Ngày chi phí (YYYY-MM-DD)")
    allocation_method: str = Field("direct", max_length=50, description="Phương thức phân bổ")
    allocation_basis_note: Optional[str] = Field(None, max_length=500, description="Ghi chú phân bổ")
...
class ExpenseListRequest(BaseModel):
    ...
    vendor: Optional[str] = Field(None, description="Lọc theo vendor (tìm kiếm gần đúng)")
