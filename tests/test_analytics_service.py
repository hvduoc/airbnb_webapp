...
class TestAnalyticsService:
    ...
    def test_revenue_vs_expense_dashboard_success(self):
        ...
        with patch.object(service, "require_permission"):
            with patch(
                "services.analytics_service.RevenueService"
            ) as MockRevenueService:
                with patch(
                    "services.analytics_service.ExpenseService"
                ) as MockExpenseService:
                    # Setup mocks
                    MockRevenueService.return_value.revenue_by_property.return_value = (
                        mock_revenue_data
                    )
                    MockExpenseService.return_value.summary_by_property.return_value = (
                        mock_expense_data
                    )
    ...
    def test_occupancy_metrics_calculation(self):
        ...
        assert (
            result["summary"]["total_nights_available"] == 60
        )  # 2 properties * 30 days
    ...
    def test_arpu_metrics_calculation(self):
        ...
        mock_revenue_data = {
            ...
            "properties": [
                {
                    "property_id": 1,
                    "property_name": "High ARPU Property",
                    "total_revenue": 4000000,
                    "total_bookings": 5,
                },
                {
                    "property_id": 2,
                    "property_name": "Low ARPU Property",
                    "total_revenue": 2000000,
                    "total_bookings": 7,
                },
            ],
    ...
    def test_monthly_trends_generation(self):
        ...
        mock_expense_results = [
            type("obj", (object,), {"month": "2025-09", "monthly_expenses": 800000})(),
            type("obj", (object,), {"month": "2025-10", "monthly_expenses": 1200000})(),
        ]

        # Setup mock to return different results for different queries
        service.db.exec.return_value.all.side_effect = [
            mock_revenue_results,
            mock_expense_results,
        ]
    ...
    def test_analytics_permission_denied(self):
        ...
        with patch.object(
            ...
            side_effect=HTTPException(
                status_code=403, detail="Insufficient permission: analytics/read"
            ),
        ):
            # Act & Assert
    ...
    def test_empty_data_handling(self):
        ...
        # Mock empty data
        mock_empty_revenue = {
            "summary": {"total_revenue": 0, "total_bookings": 0},
            "properties": [],
        }
