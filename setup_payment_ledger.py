...
def setup_payment_ledger():
    ...
    if not run_command("pip install -r requirements_payments.txt", "Installing Payment Ledger dependencies"):
    ...
    try:
        ...
        result = subprocess.run([sys.executable, "create_payment_users.py"], 
