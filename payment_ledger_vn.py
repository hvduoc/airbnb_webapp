...
recipients = [
    {"id": "nguyen_van_a", "name": "Nguyễn Văn A", "role": "Trợ lý", "phone": "0901234567"},
    {"id": "tran_thi_b", "name": "Trần Thị B", "role": "Quản lý", "phone": "0902345678"},
    {"id": "le_van_c", "name": "Lê Văn C", "role": "Kế toán", "phone": "0903456789"},
    {"id": "pham_thi_d", "name": "Phạm Thị D", "role": "Chủ sở hữu", "phone": "0904567890"}
]

app = FastAPI(title="Hệ thống Thu Chi Airbnb", description="Quản lý thu chi và bàn giao tiền mặt")
...
async def get_dashboard(request: Request):
    ...
    cash_payments = sum(p["amount_collected"] for p in payments_db if p["payment_method"] == "cash")
    cash_handed_over = sum(h["amount"] for h in handovers_db if h["status"] == "completed")
